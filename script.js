...
function projects() {
    let projects = [
        {
            ...
            description: 'Website to get monitor cryptocurrency values and get the latest on crypto. Built with a team of two other advisors using HTML, CSS, Bulma, JavaScript, and Reddit and Coincap APIS'
        },
        {
            ...
            description: 'Website to get the current weather and the forecast for a given location. built using HTML, CSS, JavaScript, Open Weather API, and Bootstrap'
        },
        {
            projectName: 'E-commerce backend',
            repo: 'https://github.com/Brichardson117/improved-bassoon',
            deployed: 'https://youtu.be/Yu8h0E0yCIc',
            description: 'a command-line application to view, add, update and remove products for a store'
        },
        {
            projectName: 'Crypto Watch',
            repo: 'https://github.com/Brichardson117/Crypto-Watch',
    ...
    for(let i = 0; i < projects.length; i++){
     let projectDiv = document.createElement('div');
      ...
      projectDiv.append(projectName, projectDescription, projectRepo, projectDeployed);
